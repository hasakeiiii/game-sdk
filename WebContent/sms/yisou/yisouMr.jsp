...
//124.232.156.42:8080/sms/esou/yisouMr.jsp?sid=123456789&status=success
...
if(azul.SpTool.mr("1006",linkid,"","",msg,"success")){
	out.println("0");
	...
	try {
		...
		if(rsA.next()){
			...
			if("000".equals(cid)){
				azul.KeyTool.send("http://m.ztytech.com.cn/gate/easou/easouMr.jsp?"+request.getQueryString());
			}
		}
	} catch (Exception e) {
		e.printStackTrace();
