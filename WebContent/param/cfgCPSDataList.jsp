...
{
	//alert(obj.value);
	document.mainForm.action="cfgCPSDataList.jsp?op=selgame&channel_no=<%=channel_no%>";
...
{
	document.mainForm.action="cfgCPSDataList.jsp?op=sel&channel_no=<%=channel_no%>";
	document.mainForm.submit();
}
...
function goSearch(){
	...
	document.mainForm.action="cfgCPSDataList.jsp?op=sch&channel_no=<%=channel_no%>";
	document.mainForm.submit();
}
</script>
