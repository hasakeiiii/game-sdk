...
<jsp:include page="../check.jsp?check=cfgCPGameEdit.jsp" flush="true" />
<%
...
CpManage cp = cpmanageDao.getRecord1(ID);
int cp_no = cp.getCpNo();
...
else
{
	...
	//List<App> list=appDao.getList(pageno,30,"select * from app order by id desc limit 1");
...
function btnSave(){
    ...
    if('<%=id%>'=="0"){
        document.mainForm.action="cfgCPGameAction.jsp?op=add&paywaysign="+paywaysign;
        console.log("post的时候paywaysign为："+paywaysign);
        document.mainForm.submit();
    }
    else{//编辑功能
        document.mainForm.action="cfgCPGameAction.jsp?op=edit&paywaysign="+paywaysign+"&pageno=<%=pageno%>&id=<%=id%>";
        console.log("post的时候paywaysign为："+paywaysign);
        document.mainForm.submit();
    }
}
...
function initcheck(){
	...
	for(var i=0;i < length;i++){
		...
		console.log("进入了4");
		var str2=new Array('1','1','1','1','1','1','1','1','1');
...
var paywaysign = "111111111";
var str=new Array('1','1','1','1','1','1','1','1','1');
	...
	<form name="mainForm" id="mainForm" method="post"
		...
		<table width="100%" border="0">
			...
			<tr align="center">
				...
				<td width="33%"><select name="game_type" id="game_type">
		...
		<div id="wy">
			<table width="100%" border="0">
				...
				<tr align="center">
					...
					<td width="33%" id="title_cp_no">密匙</td>
					<td width="33%"><input name="cp_no" alt="cp_no"
						value="<%=cp_no%>" maxlength="250" />
					</td>
					<td><span id="warn_sp_mykey"></span>
					</td>
				</tr>
...
<!-- 				</tr> -->
<!-- 				<tr align="center"> -->
<!-- 				<td width="33%" id="title_onlyoff">专属币折扣</td> -->
...
<!-- 				<tr align="center">
				...
				<tr align="center">
					<td width="33%" id="title_cpcpcount">扣量比例</td>
					<td width="33%"><input name="cpcpcount" alt="cpcpcount_null"
						value="<%=cpcpcount%>" maxlength="250" />
					</td>
					<td><span id="warn_disurl_code"></span>
					</td>
				</tr>
