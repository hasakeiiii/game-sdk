...
List<Object> list = new ArrayList<Object>();
     if(action.equals("ation"))
     {
    	  ...
    	  list=mmPayDao.getPayRecordLikeOrderNO(order_no);//getPayRecordByOrderNO
...
<%-- <td width="10%">订单号&nbsp;&nbsp;<input id = "order_no1" name="order_no1" value="<%=order_no1%>"type="file" onclick="getFullPath(this)"/>&nbsp;&nbsp;
</td> --%>
...
function goSearch(){
	...
	document.mainForm.action="MmpayVagueSearch.jsp?op=ation";
