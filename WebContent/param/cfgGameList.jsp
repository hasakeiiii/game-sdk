...
String pageSql="select * from app where 1=1";
if(!keyWord.equals("")){
...
for(int i=0;i<list.size();i++){
    ...
    String gameTypeStr = "";
    if(app.getGameType().equals("off_line"))
    {
    	gameTypeStr = "单机";
    }
    else if(app.getGameType().equals("mm_on_line"))
    {
    	gameTypeStr = "MM网游";
    }
    else if(app.getGameType().equals("on_line"))
    {
    	gameTypeStr = "网游";
    }
    else{
...
<script>
function addAct(){
    window.location="cfgGameEdit.jsp";
}
function editAct(id){
	window.location="cfgGameEdit.jsp?pageno=<%=pageno%>&id="+id;
}
function infoAct(id){
