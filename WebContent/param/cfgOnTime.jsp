   ...
   $.post(
   		...
   		function(data){
    		...
    		$.each(list,function(i,item){
    			...
    			table_tr += "<td>" + (item[0]*100/sum).toFixed(2) + '%' +"("+item[0]+")"+"</td>";
    			table_tr += "<td>" + (item[1]*100/sum).toFixed(2) + '%' +"("+item[1]+")"+"</td>";
    			table_tr += "<td>" + (item[2]*100/sum).toFixed(2) + '%' +"("+item[2]+")"+"</td>";
    			table_tr += "<td>" + (item[3]*100/sum).toFixed(2) + '%' +"("+item[3]+")"+"</td>";
    			table_tr += "<td>" + (item[4]*100/sum).toFixed(2) + '%' +"("+item[4]+")"+"</td>";
    			table_tr += "<td>" + (item[5]*100/sum).toFixed(2) + '%' +"("+item[5]+")"+"</td>";
    			table_tr += "<td>" + (item[6]*100/sum).toFixed(2) + '%' +"("+item[6]+")"+"</td>";
    			table_tr += "<td>" + (item[7]*100/sum).toFixed(2) + '%' +"("+item[7]+")"+"</td>";
    			table_tr += "<td>" + (item[8]*100/sum).toFixed(2) + '%' +"("+item[8]+")"+"</td>";
    			...
    			sumall = sum0+sum1+sum2+sum3+sum4+sum5+sum6+sum7+sum8;
    			
    		});
			var table_trr = "<tr align='center'>";
			table_trr += "<td>"+ "总计"+ "</td>";
			table_trr += "<td>" + "" + "</td>";
			table_trr += "<td>" + (sum0*100/sumall).toFixed(2) + '%' +"("+sum0+")"+"</td>";
			table_trr += "<td>" + (sum1*100/sumall).toFixed(2) + '%' +"("+sum1+")"+"</td>";
			table_trr += "<td>" + (sum2*100/sumall).toFixed(2) + '%' +"("+sum2+")"+"</td>";
			table_trr += "<td>" + (sum3*100/sumall).toFixed(2) + '%' +"("+sum3+")"+"</td>";
			table_trr += "<td>" + (sum4*100/sumall).toFixed(2) + '%' +"("+sum4+")"+"</td>";
			table_trr += "<td>" + (sum5*100/sumall).toFixed(2) + '%' +"("+sum5+")"+"</td>";
			table_trr += "<td>" + (sum6*100/sumall).toFixed(2) + '%' +"("+sum6+")"+"</td>";
			table_trr += "<td>" + (sum7*100/sumall).toFixed(2) + '%' +"("+sum7+")"+"</td>";
			table_trr += "<td>" + (sum8*100/sumall).toFixed(2) + '%' +"("+sum8+")"+"</td>";
