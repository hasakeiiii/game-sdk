...
{
	//alert(obj.value);
	document.mainForm.action="cfgCPA_RDataList_T.jsp?op=selgame";
...
{
	document.mainForm.action="cfgCPA_RDataList_T.jsp?op=sel";
	document.mainForm.submit();
}
...
function goSearch(){
	...
	document.mainForm.action="cfgCPA_RDataList_T.jsp?op=sch";
	document.mainForm.submit();
}
</script>
