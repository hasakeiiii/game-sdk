...
function gametypechg(obj){
	document.mainForm.action="cfgPayTypeList.jsp?op=selgame>";
...
{
	//alert(obj.value);
	document.mainForm.action="cfgPayTypeList.jsp?op=selbusiness";
	document.mainForm.submit();
}
function channelchg(obj)
{
	document.mainForm.action="cfgPayTypeList.jsp?op=selchannel";
	document.mainForm.submit();
}

function packetchg(obj)
{
	document.mainForm.action="cfgPayTypeList.jsp?op=sel";
	document.mainForm.submit();
}
...
function goSearch(){
	...
	document.mainForm.action="cfgPayTypeList.jsp?op=sch";
	document.mainForm.submit();
}
</script>
