...
{
	//alert(obj.value);
	document.mainForm.action="cfgCPA_RDataList.jsp?op=selgame&channel_no=<%=channel_no%>";
...
{
	document.mainForm.action="cfgCPA_RDataList.jsp?op=sel&channel_no=<%=channel_no%>";
	document.mainForm.submit();
}
...
function goSearch(){
	...
	document.mainForm.action="cfgCPA_RDataList.jsp?op=sch&channel_no=<%=channel_no%>";
	document.mainForm.submit();
}
</script>
