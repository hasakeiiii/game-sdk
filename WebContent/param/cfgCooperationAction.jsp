...
String act_flag="-1";
String msg="操作失败";
String toPage="cfgCooperationList.jsp?pageno="+pageno;
...
/*  if(!act_flag.equals("-1")){
	...
	if(!cooperation.getMobileVague().equals("")){
		Vague vague = vagueDao.getRecord(cooperation.getMobileVague());
		if(!vague.getVaguePacket().contains(cooperation.getPacketId())){
			vague.vaguePacket +=","+cooperation.getPacketId();
			vagueDao.edit(vague);
		}
	}	
}  */
