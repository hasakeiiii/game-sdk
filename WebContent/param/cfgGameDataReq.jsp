...
<td><%=channelDataStr.registerStr%></td>
<td><%=channelDataStr.realregisterNumStr%></td>
<td><%=channelDataStr.loginStr%></td>
<td><%=channelDataStr.actRegistrStr%></td>
<td><%=channelDataStr.date1R%></td>
<td><%=channelDataStr.date7R%></td>
<td><%=channelDataStr.date30R%></td>
<td><%=channelDataStr.telpaystr%></td>
<td><%=channelDataStr.newtelpaystr%></td>
<td><%=channelDataStr.thpaystr%></td>
<td><%=channelDataStr.newthpaystr%></td>
<td><%=channelDataStr.payRatio%></td>
<td><%=channelDataStr.payAccountPay%></td>
<td><%=channelDataStr.AccountPay%></td>
</tr>
<%
}
%>
...
<td><%=channelDataSta.regcount%></td>
<td><%=channelDataSta.allrealregisterNum%></td>
<td></td>
<td><%=gameDataReqTableColorStaStr.allactRegistrStr%></td>
<td><%=gameDataReqTableColorStaStr.alldate1R%></td>
<td><%=gameDataReqTableColorStaStr.alldate7R%></td>
<td><%=gameDataReqTableColorStaStr.alldate30R%></td>
<td><%=gameDataReqTableColorStaStr.telpaycountstr%></td>
<td><%=gameDataReqTableColorStaStr.newalltelpaystr%></td>
<td><%=gameDataReqTableColorStaStr.thpaycountstr%></td>
<td><%=gameDataReqTableColorStaStr.newallthpaystr%></td>
<td><%=gameDataReqTableColorStaStr.AllpayRatio%></td>
<td><%=gameDataReqTableColorStaStr.AllpayAccountPay%></td>
<td><%=gameDataReqTableColorStaStr.AllAccountPay%></td>
</tr>
</table>
</form>
<%
...
function gametypechg(obj){
	document.mainForm.action="cfgGameDataReq.jsp?op=selgame";
...
{
	//alert(obj.value);
	document.mainForm.action="cfgGameDataReq.jsp?op=selbusiness";
	document.mainForm.submit();
}
function channelchg(obj)
{
	document.mainForm.action="cfgGameDataReq.jsp?op=selchannel";
	document.mainForm.submit();
}

function packetchg(obj)
{
	document.mainForm.action="cfgGameDataReq.jsp?op=sel";
	document.mainForm.submit();
}
...
function goSearch(){
	...
	document.mainForm.action="cfgGameDataReq.jsp?op=sch";
	document.mainForm.submit();
}
</script>
...
//out.println(azul.JspUtil.initSelect("channel_no",dataReqService.channelMap,dataReqService.channel_no));//
