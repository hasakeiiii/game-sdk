...
public class CooperationTelAction extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CooperationTelAction() {
		super();
	}
	...
	private void operateRemind(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		String telcom_pay_type = request.getParameter("telcom_pay_type");
		String telcom_pay1_type = request.getParameter("telcom_pay1_type");
		String telcom_pay2_type = request.getParameter("telcom_pay2_type");
		String telcom_pay3_type = request.getParameter("telcom_pay3_type");
		String telcom_pay_id = request.getParameter("telcom_pay_id");
		String telcom_pay1_id = request.getParameter("telcom_pay1_id");
		String telcom_pay2_id = request.getParameter("telcom_pay2_id");
		String telcom_pay3_id = request.getParameter("telcom_pay3_id");
		String telcom_pay1_param = request.getParameter("telcom_pay1_param");
		String telcom_pay2_param = request.getParameter("telcom_pay2_param");
		String telcom_pay3_param = request.getParameter("telcom_pay3_param");
	...
	/*	String mmDayPayProvince = request.getParameter("mmDayPayProvince");
		...
		fee.setTelcomPayType(telcom_pay_type);
		fee.setTelcomPayId(telcom_pay_id);
		fee.setTelcomPay1Type(telcom_pay1_type);
		fee.setTelcomPay2Type(telcom_pay2_type);
		fee.setTelcomPay3Type(telcom_pay3_type);
		fee.setTelcomPay1Id(telcom_pay1_id);
		fee.setTelcomPay2Id(telcom_pay2_id);
		fee.setTelcomPay3Id(telcom_pay3_id);
		fee.setTelcomPay1Param(telcom_pay1_param);
		fee.setTelcomPay2Param(telcom_pay2_param);
		fee.setTelcomPay3Param(telcom_pay3_param);
	...
	private void handleRemind(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
		...
		pay_TypeMap.put("9","电信全网");
		pay_TypeMap.put("7","电信十分科技");
		pay_TypeMap.put( "0","关");
		...
		request.getRequestDispatcher("../param/cfgCooperationTel.jsp").forward(request, response);
