...
public class DataQueryExcelAction extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DataQueryExcelAction() {
		super();
	}
	...
	//	Integer day = "请选择".equals(dayStr) ? -1 : Integer.parseInt(dayStr); 
		...
		Map<String,Object> rawMap = null;
			...
			HSSFWorkbook wb = ExcelUtil.writeXLS(0, list);
			
			
			//FileOutputStream fileOut;
			//String path = "E:\\";
			SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
			String filename = "sjcx".concat(sdf.format(new Date())).concat(".xls");
		/*	try {
