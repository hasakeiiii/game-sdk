...
public class ThreeProvinceAction extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ThreeProvinceAction() {
		super();
	}
...
/*		Cooperation coo = new Cooperation();
		...
		Map<String,Object> rawMap = null;
			...
			rawMap = dao.getLtvList(apkNo,gameNo,businessNo,beginDate,pageSize,curPage);
