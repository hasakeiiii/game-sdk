...
public class changePasswordOld extends HttpServlet{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2887803258351979848L;

	public static String url = ConstValue.RDRServerUrl+"/changePassword";
